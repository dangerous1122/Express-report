  ...
  return (
    <div className="lg:my-0 my-0">
      <div className="mx-auto max-w-5xl px-6 lg:px-8">
        <div className="mx-auto sm:mt-0 pt-20 lg:mx-0 lg:flex justify-around lg:max-w-none">
          {plans.map((plan) => (
            <form
              onSubmit={handleSubmit}
              key={plan.id}
              className=" p-2 lg:mt-0 lg:w-full lg:max-w-sm lg:flex-shrink-0 mb-4"
            >
              <div
                className={`rounded-2xl bg-gray-50 py-10 text-center ring-1 lg:mt-32 mt-10 ring-inset ring-gray-900/5 lg:flex lg:flex-col lg:justify-center lg:py-16 ${
